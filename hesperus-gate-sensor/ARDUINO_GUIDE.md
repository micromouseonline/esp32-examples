...
## Target Environment: `hesperus-esp32-s3-zero`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `hesperus-esp32-s3-super-mini`
### 1. Arduino IDE Menu Settings
* **Target Board:** Select the menu item corresponding to platformio board target: `esp32-s3-devkitc-1`
* **Flash Size:** 4MB
...
## Target Environment: `hesperus-esp32-s3-cyd-touch-freenove`
### 1. Arduino IDE Menu Settings
* **Target Board:** Select the menu item corresponding to platformio board target: `esp32-s3-devkitc-1`
* **Flash Size:** 16MB
...
## Target Environment: `hesperus-esp32-c3`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `hesperus-esp32-c3-xiao`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `hesperus-esp32-c6-xiao`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `hesperus-esp32-c6`
### 1. Arduino IDE Menu Settings
* **Target Board:** Select the menu item corresponding to platformio board target: `esp32-c6-devkitc-1`
* **Flash Size:** 4MB
