...
## Target Environment: `cyd-font-demo-s3-cyd-touch-freenove`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `cyd-font-demo-cyd2usb-diymalls-ili9341`
### 1. Arduino IDE Menu Settings
...
## Target Environment: `cyd-font-demo-cyd2usb-diymalls-st7789`
### 1. Arduino IDE Menu Settings
* **Target Board:** Select the menu item corresponding to platformio board target: `esp32dev`
* **Flash Size:** 4MB
...
## Target Environment: `cyd-font-demo-jc2432w328c`
### 1. Arduino IDE Menu Settings
* **Target Board:** Select the menu item corresponding to platformio board target: `esp32dev`
* **Flash Size:** 4MB
