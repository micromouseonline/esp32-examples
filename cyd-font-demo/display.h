// ----------------------------------------------------------------------------
//  display.h — LovyanGFX board configs for cyd-font-demo. CYD-family boards
//  only -- copied from cerberus-gate-controller/display.h, minus the M5 Core
//  branch (no touchscreen, not a target here).
// ----------------------------------------------------------------------------
#pragma once
...
#else
#error "display.h: no known display configuration for this board (cyd-font-demo targets CYD-family boards only)"
#endif
